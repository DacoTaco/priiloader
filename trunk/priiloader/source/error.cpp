	...
	if( error >= 0 )
	{
		...
		switch( error )
		{
			...
			case ERROR_BOOT_DOL_OPEN:
				PrintFormat( 0, 16, 352, "Error autobooting file, try reinstalling!");
				PrintFormat( 0, 16, 368, "Could not open file!");
			break;
			case ERROR_BOOT_DOL_READ:
				PrintFormat( 0, 16, 352, "Error autobooting file, try reinstalling!");
				PrintFormat( 0, 16, 368, "Reading the file failed!");
			break;
			case ERROR_BOOT_DOL_SEEK:
				PrintFormat( 0, 16, 352, "Error autobooting file, try reinstalling!");
				PrintFormat( 0, 16, 368, "Seek failed!");
			break;
			case ERROR_BOOT_DOL_ENTRYPOINT:
				PrintFormat( 0, 16, 352, "Error autobooting file, try reinstalling!");
				PrintFormat( 0, 16, 368, "Entrypoint is zero!");
			break;
			case ERROR_ISFS_INIT:
				PrintFormat( 0, 16, 352, "ISFS_Initialize() failed");
			break;
			case ERROR_BOOT_HBC:
			...
			case ERROR_SETTING_OPEN:
				PrintFormat( 0, 16, 352, "Problems with settings.ini!");
				PrintFormat( 0, 16, 352, "Could not open/create file!");
			break;
			case ERROR_SETTING_WRITE:
				PrintFormat( 0, 16, 352, "Problems with settings.ini!");
				PrintFormat( 0, 16, 352, "Could not write file!");
			break;
			case ERROR_SETTING_READ:
				PrintFormat( 0, 16, 352, "Problems with settings.ini!");
				PrintFormat( 0, 16, 352, "Could not read file!");
			break;
			case ERROR_THREAD_CREATE:
				PrintFormat( 0, 16, 352, "LWP_CreateThread() failed!");
			break;
			case ERROR_MALLOC:
				PrintFormat( 0, 16, 352, "malloc failed!");
			break;
			...
			case ERROR_SYSMENU_TIKSIZEGETFAILED:
				PrintFormat( 0, 16, 352, "Error autobooting systemmenu!");
				PrintFormat( 0, 16, 368, "Could not get ticket size!");
			break;
			case ERROR_SYSMENU_TIKREADFAILED:
				PrintFormat( 0, 16, 352, "Error autobooting systemmenu!");
				PrintFormat( 0, 16, 368, "Could not read ticket!");
			break;
			...
			case ERROR_SYSMENU_GETTMDSIZEFAILED:
				PrintFormat( 0, 16, 352, "Error autobooting systemmenu!");
				PrintFormat( 0, 16, 368, "Could not get TMD size!");
			break;
			case ERROR_SYSMENU_GETTMDFAILED:
				PrintFormat( 0, 16, 352, "Error autobooting systemmenu!");
				PrintFormat( 0, 16, 368, "Could not get TMD!");
			break;
			case ERROR_SYSMENU_BOOTNOTFOUND:
				PrintFormat( 0, 16, 352, "Error autobooting systemmenu!");
				PrintFormat( 0, 16, 368, "Boot file not found!");
			break;
			case ERROR_SYSMENU_BOOTOPENFAILED:
				PrintFormat( 0, 16, 352, "Error autobooting systemmenu!");
				PrintFormat( 0, 16, 368, "Could not open boot file!");
			break;
			case ERROR_SYSMENU_BOOTGETSTATS:
				PrintFormat( 0, 16, 352, "Error autobooting systemmenu!");
				PrintFormat( 0, 16, 368, "Could not get boot stats!");
			break;
			/*
			default:
				PrintFormat( 0, 16, 352, "Unknown error:%d\n", error);
				break;*/
		}
	}
}
